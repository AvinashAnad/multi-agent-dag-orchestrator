...
_TOOL_CATALOG = {
    ...
    "list_dir": {
        "name": "list_dir",
        "description": (
            "List the contents of a sandbox directory. Use this to discover "
            "all files in a folder before indexing them (e.g. call list_dir "
            "on 'papers/' to find every .md file, then index each one). "
            "Path is relative to the sandbox root."
        ),
        "input_schema": {
            "type": "object",
